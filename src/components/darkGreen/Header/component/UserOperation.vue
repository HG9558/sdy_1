          ...
          <div class="user-detail">
            <div class="user_detail_top">
              ...
              <div class="user-level">
                <span class="user-level_num"> {{userInfo.levelName.replace(/[^\d.]/g, "")|| "0" }} </span>
              </div>
            </div>
            <div class="userInfo-balance">
              {{ (centerBalanceMoney > 0 && centerBalanceMoney.toFixed(2)) || "0.00"}}<template v-if="isZhLanguage">{{$t('CNY')}}</template>
