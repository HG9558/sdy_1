  ...
  <div class="special-wrapper">
    <div class="special-container">
      <div class="special-content">
        ...
        <div class="special-entry" @click="enterGame">{{$t('进入游戏')}}</div>
        <div class="special-btns">
          <div class="special-btns-item" v-for="(item,index) in renderList" :key="item.id" @click="changeSelectIndex(index)">
            <img class="icon" :src="require(`./img/icon_${currentSelectIndex === index ? item.depotCode.toLowerCase() + '_active': item.depotCode.toLowerCase()  }.png`)" >
