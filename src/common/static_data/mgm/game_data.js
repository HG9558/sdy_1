...
export const baseMenuData = {
  sportsMenu: {
    ...
    list: [
      ...
      // { depotCode: 'FBSP', img_src: 'sports_bog', title: 'MGM体育', enTxt: 'MGM SPORTS' },
      ...
      // { depotCode: 'OBSP', img_src: 'sports_fb', title: 'OB体育', enTxt: 'OB SPORTS' },
      // { depotCode: 'PLSP', img_src: 'sports_bl', title: '保利体育', enTxt: 'PL SPORTS' },
      // { depotCode: 'PLSP', img_src: 'sports_xj', title: '小金体育', enTxt: 'POLY SPORTS' }, // 小金 替换 保利， 实际还是 保利
  ...
  realMenu: {
    ...
    list: [
      ...
      { depotCode: 'DG', img_src: 'real_dg', title: 'DG真人', enTxt: 'DG LIVE CASINO' },
      { depotCode: 'AELI', img_src: 'real_aeli', title: 'AE真人', enTxt: 'AE LIVE CASINO' },
      { depotCode: 'SA', img_src: 'real_sa', title: 'SA真人', enTxt: 'SA LIVE CASINO' },
      // { depotCode: 'EB', img_src: 'real_eb', title: 'EB真人', enTxt: 'EB LIVE CASINO' },
      ...
      { depotCode: 'EB', img_src: 'real_eb', title: 'EB真人', enTxt: 'EB LIVE CASINO' },
      { depotCode: 'AB', img_src: 'real_ab', title: 'AB真人', enTxt: 'AB LIVE CASINO' },
    ]
  },
  chessMenu: {
    saveType: 'set_poker',
    ...
    catId: 6,
    list: [
      { depotCode: 'BL', img_src: 'chess_bl', enTxt: 'BL CHESS', title: '博乐棋牌', topGameType: 'poker' },
  ...
  electronicMenu: {
    ...
    list: [
      ...
      { depotCode: 'XA', img_src: 'electronic_xa', enTxt: 'IA ESPORTS', title: '小艾电竞' },
  ...
  lotteryMenu: {
    ...
    catId: 12,
    list: [
      { depotCode: 'YBCP', img_src: 'lottery_ybcp', title: '云博彩票', enTxt: 'YB LOTTERY GAME', topGameType: 'lottery' },
  ...
  slotMenu: {
    ...
    list: [
      ...
      { depotCode: 'JILI', img_src: 'slot_jili', enTxt: 'JILI GAME', title: 'JILI电子', topGameType: 'electronic' },
      { depotCode: 'SG', img_src: 'slot_sg', enTxt: 'SG GAME', title: 'SG电子', topGameType: 'electronic' },
      ...
      // { depotCode: 'AGST', img_src: 'slot_ag', enTxt: 'AG GAME', title: 'AG电子', topGameType: 'electronic' },
    ]
  },
  discountMenu: {
    list: [
...
export const hotGameList = [
  ...
  },
  {
    ...
    gameInner: '超过百种彩票玩法任您赢！美高梅娱乐城为全球各彩票玩家提供了丰富多样的游戏内容，致力为玩家打造高品质的娱乐环境，安心乐享游戏空间，只为公平、公正的开奖结果。'
  },
  {
    type: 'electronic',
    title: "电子",
