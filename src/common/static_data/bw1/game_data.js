...
export const baseMenuData = {
  ...
  realMenu: {
    ...
    list: [
      ...
      { depotCode: 'CQYX', img_src: 'real_cqyx', title: 'CQ9真人', enTxt: 'CQ9 LIVE CASINO' },
			{ depotCode: 'WM', img_src: 'real_wm', title: 'WM真人', enTxt: 'WM LIVE CASINO' },
		]
  },
  chessMenu: {
    saveType: 'set_poker',
  ...
  slotMenu: {
    ...
    list: [
      ...
      { depotCode: 'AGST', img_src: 'slot_ag', enTxt: 'AG GAME', title: 'AG电子', topGameType: 'electronic' },
			{ depotCode: 'GR', img_src: 'slot_gr', enTxt: 'GR GAME', title: '好路电子', topGameType: 'electronic' },
...
export const hotGameList = [
  ...
  },
  {
    ...
    gameInner: '超过百种彩票玩法任您赢！澳世娱乐城为全球各彩票玩家提供了丰富多样的游戏内容，致力为玩家打造高品质的娱乐环境，安心乐享游戏空间，只为公平、公正的开奖结果。'
  },
  {
    type: 'electronic',
    title: "电子",
