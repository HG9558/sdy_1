...
export const baseMenuData = {
  sportsMenu: {
    ...
    catId: 1,  // - 请求游戏参数表示
    list: [
      { depotCode: 'OBSP', img_src: 'sports_bog', title: 'BET88极速体育', enTxt: 'BET88 SPORTS' },
  ...
  realMenu: {
    ...
    list: [
      ...
      { depotCode: 'SEX', img_src: 'real_sex', title: '性感百家乐', enTxt: 'AE LIVE CASINO' },
      { depotCode: 'EB', img_src: 'real_ebet', title: 'EBET真人', enTxt: 'EBET LIVE CASINO' },
  ...
  slotMenu: {
    ...
    list: [
      ...
      { depotCode: 'PP', img_src: 'slot_pp', enTxt: 'PGS GAME', title: 'PP电子', topGameType: 'electronic' },
      ...
      { depotCode: 'DT', img_src: 'slot_dt', enTxt: 'MG2 GAME', title: 'DT电子', topGameType: 'electronic' },
...
export const hotGameList = [
  ...
  },
  {
    ...
    gameInner: '超过百种彩票玩法任您赢！昇得源为全球各彩票玩家提供了丰富多样的游戏内容，致力为玩家打造高品质的娱乐环境，安心乐享游戏空间，只为公平、公正的开奖结果。'
  },
  {
    type: 'electronic',
    title: "电子",
