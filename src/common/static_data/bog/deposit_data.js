...
export const noticeTextData = {
  ...
  '本地银行': '请使用手机银行App或U盾网银付款，请按照提交后页面实际显示金额充值，切勿保存转账人信息私下转账，否则无法自动到账！',
  '微信': '温馨提示：请使用微信App进行付款，请勿重复支付，',
  '网银支付': '请使用手机银行App或U盾网银付款，请勿重复支付，',
  '扫码支付': '请勿重复支付，',
  'QQ支付': '温馨提示：请使用QQ进行付款，请勿重复支付，',
  'EBPAY': '温馨提示：请使用EBAY APP进行付款，请勿重复支付，请按照提交后页面实际显示金额充值，否则无法自动到账！',
  'TOPAY': '温馨提示：请使用TOPAY APP进行付款，请勿重复支付，请按照提交后页面实际显示金额充值，否则无法自动到账！',
  '极速存款': ['1.在15分钟内完成充值操作，可获得1%存款礼金，最高得1000元；', '2.若每日多次在规定时间内未完成充值，将取消您使用该充值方式的权利。'],
  '数字人民币': ['1.在15分钟内完成充值操作，可获得1%存款礼金，最高得1000元；', '2.若每日多次在规定时间内未完成充值，将取消您使用该充值方式的权利。']
}
