...
export const baseMenuData = {
  sportsMenu: {
    ...
    catId: 1,  // - 请求游戏参数表示
    list: [
      { depotCode: 'OBSP', img_src: 'sports_bog', title: '浩博体育', enTxt: 'HB SPORTS' },
      ...
      { depotCode: 'SXSP', img_src: 'sports_sxsp', title: '皇冠体育', enTxt: 'HG SPORTS' },
    ]
  },
  sabongNemu: {
    saveName: 'sabong',
  ...
  electronicMenu: {
    ...
    list: [
      ...
      { depotCode: 'OBES', img_src: 'electronic_obes', enTxt: 'OB ESPORTS', title: 'OB电竞' },
    ]
  },
  lotteryMenu: {
    ...
    list: [
      ...
      { depotCode: 'GYSS', img_src: 'lottery_gyss', title: 'GY彩票', enTxt: 'GYSS LOTTERY GAME', topGameType: 'lottery' },
      { depotCode: 'GYHK', img_src: 'lottery_gyhk', title: '浩博彩票', enTxt: 'GYHK LOTTERY GAME', topGameType: 'lottery' },
    ]
  },
  slotMenu: {
    ...
    list: [
      ...
      { depotCode: 'BBIS', img_src: 'slot_bbis', enTxt: 'BBIN GAME', title: 'BBIN电子', topGameType: 'electronic' },
...
export const hotGameList = [
  ...
  },
  {
    ...
    gameInner: '超过百种彩票玩法任您赢！浩博为全球各彩票玩家提供了丰富多样的游戏内容，致力为玩家打造高品质的娱乐环境，安心乐享游戏空间，只为公平、公正的开奖结果。'
  },
  {
    type: 'electronic',
    title: "电子",
