export const navigatorList = [
  ...
  // { name: "斗鸡", componentName: "SabongMenu", path: "/sabong", icon: 'sabong', },
  ...
  { name: "历史赞助", componentName: "SponsorMenu", path: "/sponsor", icon: '', },
]
...
export const returnWaterData = {
  SportsMenu: { img_src: 'return_water_two', en_flag: 'sports_flag' },
  RealMenu: { img_src: 'return_water_two', en_flag: 'real_flag' },
  ChessMenu: { img_src: 'return_water_two', en_flag: 'chess_flag' },
  ...
  SabongMenu: { img_src: null, en_flag: 'perate_flag' },
}
