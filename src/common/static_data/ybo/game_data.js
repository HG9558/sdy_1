...
export const baseMenuData = {
  sportsMenu: {
    ...
    catId: 1,  // - 请求游戏参数表示
    list: [
      { depotCode: 'OBSP', img_src: 'sports_bog', title: '宇博体育', enTxt: 'YBO SPORTS' },
      ...
      // { depotCode: 'XM', img_src: 'sports_xm', title: '熊猫体育', enTxt: 'XJ SPORTS'},
    ]
  },
  realMenu: {
    saveType: 'set_real',
...
export const hotGameList = [
  ...
  },
  {
    ...
    gameInner: '超过百种彩票玩法任您赢！宇博为全球各彩票玩家提供了丰富多样的游戏内容，致力为玩家打造高品质的娱乐环境，安心乐享游戏空间，只为公平、公正的开奖结果。'
  },
  {
    type: 'electronic',
    title: "电子",
