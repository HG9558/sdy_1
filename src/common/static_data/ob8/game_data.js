...
export const baseMenuData = {
  sportsMenu: {
    ...
    catId: 1,  // - 请求游戏参数表示
    list: [
      { depotCode: 'OBSP', img_src: 'sports_bog', title: '欧博体育', enTxt: 'ABET SPORTS' },
      ...
      { depotCode: 'SESP', img_src: 'sports_se', title: 'SEXY体育', enTxt: 'SEXY SPORTS' },
      // { depotCode: 'PLSP', img_src: 'sports_bl', title: '保利体育', enTxt: 'PL SPORTS' },
      { depotCode: 'PLSP', img_src: 'sports_xj', title: '小金体育', enTxt: 'XIAOJIN SPORTS' }, // 小金 替换 保利， 实际还是 保利
      // todo  添加默认图片
  ...
  slotMenu: {
    ...
    list: [
      ...
      { depotCode: 'BBIS', img_src: 'slot_bbin', enTxt: 'BBIN GAME', title: 'BBIN电子', topGameType: 'electronic' },
...
export const hotGameList = [
  ...
  },
  {
    ...
    gameInner: '超过百种彩票玩法任您赢！欧博体育为全球各彩票玩家提供了丰富多样的游戏内容，致力为玩家打造高品质的娱乐环境，安心乐享游戏空间，只为公平、公正的开奖结果。'
  },
  {
    type: 'electronic',
    title: "电子",
