export const normalRoutes = [
  ...
  },
  {
    ...
    name: 'sabong',
    meta: { title: '斗鸡', },
    component: () => import(/* webpackChunkName: "sabong" */ 'pages/sabong')
  },
  {
    path: '/real', name: 'real',
    meta: { title: '真人', },
  ...
  },
  {
    ...
    name: 'catchfish',
    meta: { title: '捕鱼', },
    component: () => import(/* webpackChunkName: "electronic" */ '@/pages/blackGold/catchfish'),
    children: [
      {
        path: '',
        name: 'partList',
        ...
        component: () => import(/* webpackChunkName: "partList" */ '@/pages/blackGold/catchfish/partList')
      },
      {
        path: 'selectList',
        name: 'selectList',
        ...
        component: () => import(/* webpackChunkName: "selectList" */ '@/pages/blackGold/catchfish/selectList')
      },
    ]
  },
  {
