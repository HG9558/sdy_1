<template>
  <div class="top-game">
    <common-title titleTxt="热门游戏" subTxt="您想要的名博都有，带给您丰富的游戏体验" enTxt="Top Games"></common-title>
    ...
    <div class="content-container">
      ...
      <div class="plat-content-box">
        <div class="game-item" :class="{'is-click':selectGameIndex===index}" v-for="(item, index) in renderList[selectIndex].gameList" :key="index" @click="goTargetGame(item,index)">
          ...
          <img class="game-img isClick-img" :src="require(`../../img/topGame/${selectType}_${item.depotCode.toLowerCase()}.png`)" />
