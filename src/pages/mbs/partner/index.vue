  ...
  <div class="partner-wrapper">
    <div class="partner-banner">
      <div class="partner-main">
        <img class="partner-banner_left" src="./img/banner.png" alt="">
          ...
          <div class="contact-box">
            <div :key="index" class="contact-item" v-for="(item, index) in renderCopyList">
              <div class="contact-item-bg">
                <div class="circle-bg">
                  <img class="hy-logo" :src="require(`./img/${item.name}.svg`)"  alt="logo" />
                </div>
                <div>{{ item.title }}</div>
              </div>
    ...
    <div class="partner-content">
      ...
      <div class="partner-bg">
        ...
        <div class="partner-bottom-content">
          <img class="partner-img" src="./img/phone.png" alt="" />
          <div class="partner-right-box">
            <div class="partner-right-box_title_1">名博给力的手机APP</div>
...
import SplitLine from "../../../components/bog/SplitLine/SplitLine.vue"
  ...
  data () {
    return {
     ...
     advantageList: [
      ...
      organizationList:['英国GC监督委员会','马耳他牌照(MGA)认证','英属维尔京群岛(BVI)认证','菲律宾PAGCOR牌照']
    };
  },
  computed: {
    ...mapState({
