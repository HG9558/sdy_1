<template>
  <div class="my-friend-wrapper">
    ...
    <div class="content">
      <!-- 表单 -->
      <el-form :model="friendForm" ref="friendForm" label-width="100px" class="search-myfriend">
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item prop="firstDepositTime" label="首存时间">
              <el-date-picker @change="changeDepositTime" popper-class="black-bg" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" v-model="firstDepositTime"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item prop="incomeStatisticsTime" label="收益统计时间">
              <el-date-picker @change="changeGetTime" popper-class="black-bg" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" v-model="incomeStatisticsTime"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item prop="subLoginName" label="好友账号">
              <el-input class="friend-account" v-model="friendForm.subLoginName" placeholder="请输入好友账号"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-form-item>
          <el-button class="btn search-btn" type="primary" @click="submitForm">查询</el-button>
          <el-button class="btn reset-btn" @click="clearFom">重置</el-button>
        </el-form-item>
      </el-form>
      <!-- 表格 -->
      <common-table :showSummary="true" :reloadTotal="reloadTotal" @getFriendDetail="getFriendDetail" :tableData="tableData" :friendForm="friendForm" :tableLabel="tableLabel" :pageNo.sync="pageNo" :loading="loading" :total="total" />
    </div>
  </div>
</template>
...
export default {
  ...
  data () {
    return {
      ...
      tableLabel: [
        { label: "好友账号", prop: "subLoginName" },
        { label: "首存时间", prop: "firstChargeTime" },
