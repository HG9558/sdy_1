<template>
  <el-form class="yszjl add-bank-card-form" :model="cyBankForm" :rules="cyBankRules" label-width="130px" ref="cyBankForm" size="small">

    <el-form-item label="协议类型：" prop="currencyProtocol">
      <el-select class="w-100" popper-class="yszjl" placeholder="请选择协议类型" v-model="cyBankForm.currencyProtocol" value-key="id" @change="protocolChange">
    ...
    <el-form-item label="钱包类型：" prop="walletName">
      <el-select class="w-100" popper-class="yszjl" placeholder="请选择" v-model="cyBankForm.walletName" value-key="id">
