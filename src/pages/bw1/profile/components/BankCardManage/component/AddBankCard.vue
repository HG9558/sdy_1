  ...
  <div class="add-bank-card-dialog">
    <div class="add-bank-card-form-wrapper">
      ...
      <div class="tab-container">
       ...
       <div class="tab-main">
          <div :class="{'money-type':true, on: componentName=== 'RmbBank'}" @click="(componentName='RmbBank')&&(formName='rmbBankForm')">绑定银行</div>
...
<!--          <div :class="{'money-type':true, on: componentName=== 'OtherPay' }" @click="(componentName = 'OtherPay')&&(formName = 'otherPayForm')">其他钱包</div>-->
    ...
    <el-button class="yszjl add-bank-card-btn" :loading="bindBtnLoading" @click="_handleAddBankcard(formName)" width="250" height="36">确认</el-button>
  </div>
</template>
