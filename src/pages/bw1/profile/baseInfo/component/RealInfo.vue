<template>
  <div class="real-info-description">
    ...
    <el-form :model="form" class="yszjl real-form" label-position="top" label-width="115px" ref="form" :rules="registerFormRule">
       <el-form-item label="真实姓名：" :prop="!!exitRealName ? '' : 'realName'" :rules="realName">
        <el-input class="user-name" placeholder="姓名需与银行卡持卡人姓名一致，否则无法提款" style="width: 362px" v-model="form.realName" :disabled="!!exitRealName" :maxlength="60"></el-input>
      </el-form-item>
      <el-form-item>
        <span class="gender-label" slot="label">性 别：</span>
        <el-select class="gender-box" popper-class="yszjl gender-select" v-model="form.gender" placeholder="请选择性别">
      ...
      <el-form-item>
        <el-button type="primary" class="yszjl submit-userinfo-button" :disabled="btnDisabled" @click="_onSubmitForm" :loading="loading">提交信息</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
