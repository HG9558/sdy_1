      ...
      <div class="select-pay-form">
        ...
        <div class="select-box">
          ...
          <div class="select-form-container">
            ...
            <el-button class="handle-btn yszjl" @click="_cyPayDeposit" :loading="buttonLoading">立即存款</el-button>
          ...
          <div class="select-info">
            ...
            <div class="info-item exchange-num">当前参考汇率： 1 USDT ≈ {{exchangeRate}} A$</div>
            <div class="info-item get-money">预计到账金额：{{userGetMoney}} A$</div>
          </div>
        </div>
      </div>
      ...
      <div class="cr-pay-dialog">
        ...
        <div>
          <div class="cr-line">
            ...
            <span class="cr-value">A$ {{crPayInfo.depositAmountCNY}}</span>
          </div>
          <div class="cr-line">
        ...
        <el-button class="yszjl cr-button" type="primary" v-clipboard:copy="crPayInfo.walletAddress" v-clipboard:error="onCopyError" v-clipboard:success="onCopySuccess">点击复制钱包地址</el-button>
