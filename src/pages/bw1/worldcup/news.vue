        ...
        <div class="container">
            <div class="news-head">
                <p class="location">
                    ...
                    <router-link to='/worldcup'>世界杯</router-link> >
                    <router-link to='/worldcup?type=HotInfo'>热点资讯</router-link> >
                    <span class="txt-gold"> {{worldcupNews.title}} </span>
                </p>
                <p class="new-info">
                    <span>作者：{{worldcupNews.author}}</span>
                    <span>发布时间：{{worldcupNews.createTime}}</span>
                    <span>阅读次数：{{worldcupNews.readTotal}}</span>                               
                </p>
            </div>            
