      ...
      <div class="coupons-wrap" v-for="(item, index) in dataList" :key="index" :class="{
        ...
        <div class="coupons-wrap-border">
          <div class="coupons-wrap-first">
            ...
            <div class="scoend-div" :class="{'received-color':item.buttonShow === 3 || item.buttonShow === null, 't0': isSpecialActive(item) && !tmplCode(item).value}" v-if="!isMixingRule(item)">{{ item.amountMax }}元</div>
          </div>
