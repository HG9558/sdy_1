<template>
  <div class="table-wrapper">
    <el-table v-show="tableData.length !== 0" class="betting-table" :data="tableData" max-height="500" style="width: 100%">
      ...
      <el-table-column prop="tmplName" header-align="center" align="center" label="优惠类型" width="180">
      </el-table-column>
      <el-table-column prop="bonusAmount" header-align="center" align="center" label="彩金/奖品">
        <template slot-scope="scope">
          <span>
