<template>
  <div class="contact-us-box">
    <div class="contact-us-content">
          ...
          <div :key="index" class="contact-item" v-for="(item, index) in renderCopyList">
            <div class="contact-item_logo_bg">
              <div class="contact-item_circle">
                <img class="contact-item_logo" :src="require(`../partner/img/${item.name}.png`)" alt="logo" />
              </div>
              <div class="contact-item_logo_title">{{ item.title }}</div>
              <div class="contact-item_logo_des">{{ item.text }}</div>
            </div>

            <div class="copy-btn" v-clipboard:copy="item.text" v-clipboard:success="firstCopySuccess">
              <img class="copy-img" src="../partner/img/copy_button.png" alt="" />
            </div>
          </div>
        </div>
      </div>
      ...
      <img class="dialog-result" alt src="../partner/img/copy_sucess.png" width="182px" />
    </el-dialog>
  </div>
</template>
