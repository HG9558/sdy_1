<template>
  <div class="chat-container">
    <div class="msg-list" ref="messageBox">
    ...
    <div class="send-box">
      <div class="emoji-input">
        ...
        <el-input @keydown.native.enter="sendMessage" class="message-input_field" v-model="messageModel" :placeholder="!match ? '请选择直播房间～' : '我也来说两句！'" @focus="onFocusin" :disabled="!match" />
