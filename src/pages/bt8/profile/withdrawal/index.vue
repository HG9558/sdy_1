  ...
  <div class="withdrawal-container">
    ...
    <div class="tab-container">
      ...
      <div :class="{'tab-list':true,'on':tabActive==='rmb'}" @click="tabActive='rmb'">
        <img class="rmb-img" src="./img/rmb.png" alt="">
    ...
    <div class="withdrawal-wrapper">
      ...
      <template v-else>
        ...
        <bank-card-manage @changeCurrentBank="changeCurrentBank" :crFlag="crFlag" :tabActive="tabActive" :bankcardData="bankcardData" :isWallet="false"></bank-card-manage>
      </template>
    </div>
  </div>
</template>
