              ...
              <div v-if="props.row.odds.indexOf(',') === -1">
                <el-form label-position="left" inline class="demo-table-expand">
                  <el-form-item label="订单号" style="width: 235px;">
                    ...
                    <span style="margin-left: 10px; color: #8e745a; cursor: pointer;float: right;" v-clipboard:copy="props.row.id" v-clipboard:success="firstCopySuccess" v-clipboard:error="firstCopyError">复制</span>
                  </el-form-item>

                  <el-form-item style="text-align: center;" label="状态">
                    <span style="color: #8e745a;">{{ props.row.status }}</span>
                  </el-form-item>
                  ...
                  <el-form-item v-if="props.row.team" style="text-align: center;" label="比赛队伍">
                    <span style="color: #926942;">{{ props.row.team }}</span>
                  </el-form-item>

                  <!-- <el-form-item style="color: #8e745a;" v-show="props.row.isShowPreSettle">
                    <div>
              ...
              <div v-else>
                ...
                <el-form label-position="left" inline class="demo-table-expand" v-for="(item, index) in props.row.odds.split(',')" :key="'chuanguan-'+index" style="border-top: 1px solid rgba(255, 255, 255, 0.3)">
                  ...
                  <el-form-item v-if="props.row.team && props.row.team.split(',')[index]" style="text-align: center;" label="比赛队伍">
                    <span style="color: #926942;">{{ props.row.team.split(',')[index] }}</span>
                  </el-form-item>
                </el-form>
              </div>
            </template>
