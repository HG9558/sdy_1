<template>
  <div class="discount-wrapper" id="box">
    <img class="discount-wrapper_bannner_default" :src="siteImgMap.defaultBanner" v-if="!bannerlist.length" width="100%" alt="">
...
<!--    <RedEnvelopeEntrance />-->
    ...
    <global-dialog :title="$t('优惠详情')" :showDialog.sync="showDialog" className="discount-dialog" :width="'800px'" :hasSelfFooter="true">
...
export default {
  ...
  methods: {
    ...
    changeType (data) {
      console.log('126行打印：============:', this.discountType)
      console.log('127行打印：============:', data.name)
