<template>
  <el-form class="yszjl add-bank-card-form" :model="rmbBankForm" label-width="180px" ref="rmbBankForm" size="small" :rules="rmbBankFormDataRule">

    <el-form-item :label="$t('真实姓名：')" prop="realName">
      <el-input v-if="bankDifferentName" v-model="rmbBankForm.realName" :placeholder="$t('请输入真实姓名')" :maxlength="60"></el-input>
      <el-input v-else :disabled="!!isHaveReavName" v-model="rmbBankForm.realName" :placeholder="$t('请输入真实姓名')" :maxlength="60"></el-input>
    </el-form-item>

    <el-form-item :label="$t('银行账号：')" prop="cardNo">
      <el-input type="text" :placeholder="$t('请输入银行账号')" :maxlength="60" v-model="rmbBankForm.cardNo"></el-input>
    </el-form-item>

    <el-form-item :label="$t('* 开户银行：')">
      <el-col :span="24">
        <el-select class="w-100" popper-class="yszjl" :placeholder="$t('请选择')" v-model="rmbBankForm.bankName">
...
<!--    </el-form-item>-->
    ...
    <el-form-item class="sm-code-input" :label="$t('* 短信验证码：')" prop="code">
      <el-input v-model="rmbBankForm.code" :maxlength="6" :placeholder="$t('请输入短信验证码')">
