<template>
  <el-form class="yszjl add-bank-card-form" :model="otherPayForm" :rules="otherPayRule" label-width="130px" ref="otherPayForm" size="small">
    <el-form-item :label="$t('钱包类型：')" prop="address">
      <el-select class="w-100" popper-class="yszjl" :placeholder="$t('请选择')" v-model="otherPayForm.address" value-key="id">
        <el-option label="EBPAY" value="EBPAY"></el-option>
      </el-select>
    </el-form-item>
    <el-form-item :label="$t('钱包地址：')" prop="cardNo">
      <el-input :placeholder="$t('请输入钱包地址')" :maxlength="42" v-model="otherPayForm.cardNo"></el-input>
    </el-form-item>
    <el-form-item :label="$t('确认钱包地址：')" :maxlength="42" prop="checkCardNo">
      <el-input :placeholder="$t('请输入确认钱包地址')" v-model="otherPayForm.checkCardNo"></el-input>
    </el-form-item>
    <el-form-item :label="$t('确认钱包地址：')">
      <el-input disabled v-model="userInfo.mobile"></el-input>
    </el-form-item>

    <el-form-item class="sm-code-input" :label="$t('短信验证码：')" prop="code">
      <el-input v-model="otherPayForm.code" :maxlength="6" :placeholder="$t('请输入短信验证码')">
