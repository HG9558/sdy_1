  ...
  <div class="exclusive-vip">
    ...
    <div class="data-box vip-box" v-show="
      ...
      <div class="row bottom-btn-group">
        ...
        <div class="venue">
          <el-button :disabled="buttonShow === 3" v-show="buttonShow === 3" class="yszjl venue-btn" type="primary">{{$t('已领取')</el-button>
          <el-button :disabled="buttonShow === 0" v-show="buttonShow === 0" class="yszjl venue-btn" type="primary">{{$t('已失效')}}</el-button>
          <!-- 4 优惠稽核未通过 灰化的立即领取 -->
          <el-button v-show="buttonShow === 1 || buttonShow === 4" class="yszjl venue-btn" :type="buttonShow === 1 ? 'primary' : 'info'" :disabled="buttonShow === 4" @click="btnClick">{{$t('立即领取')}}</el-button>
          <el-button v-show="buttonShow === 2" class="yszjl venue-btn" type="primary" @click="btnClick">{{$t('立即存款')</el-button>
          <el-button v-show="buttonShow === 9" :disabled="true" class="yszjl venue-btn" type="primary">{{$t('等级不符')}}</el-button>
        </div>
      </div>
    </div>
    <div class="data-box vip-box" v-show="
    ...
    btnClick () {
      this.$http.getActApply({
        ...
        if (res.data.code === 0) {
          ...
          this.messageTip({ message: this.$t('领取成功') });
        } else {
