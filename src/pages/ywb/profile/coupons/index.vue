  ...
  <div class="coupons">
    <div class="top-div">
      ...
      <div class="coupons-wrap" v-for="(item, index) in dataList" :key="index" :class="{
        ...
        <div class="coupons-wrap-border">
          <div class="coupons-wrap-first">
            ...
            <div class="scoend-div"
              ...
              v-if="!isMixingRule(item)">{{ item.amountMax }}{{$tt('currencyValue')}}</div>
          </div>
          ...
          <div class="coupons-wrap-three">
            ...
            <button @click="openClick(index)" class="first-btn" :class="{ 'mixing-detail': isMixingRule(item) }">
              ...
              <i class="el-icon-arrow-down" style="color: #E8EDF9"
                v-show="selectDiv === null || selectDiv !== index"></i>
              <i class="el-icon-arrow-up" style="color: #E8EDF9" v-show="selectDiv === index"></i>
            </button>
            ...
            <template v-if="isMixingRule(item)">
              <div v-for="(_item, _i) in mixingDetail" :key="_i" class="mixing-detailitem">
                <div class="mixing-topbox">
                  <span class="text-color mixing-topbox-left">{{$t('领取要求：')}}{{_item.activityName}}——{{ tmplCode(_item).label }}≥{{
                  ...
                  <span class="mixing-topbox-right">
                    ...
                    <button @click="openMixingClick(_i)" class="first-btn">
                      ...
                      <i class="el-icon-arrow-up" style="color:#E8EDF9" v-show="selectMixingDiv === _i"></i>
                    </button>
        ...
        <img class="coupons-received" v-show="item.buttonShow === 3 || item.buttonShow == null"
          :src="receivedImg" alt="">
      </div>
