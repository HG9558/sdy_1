<template>
  <global-dialog :title="$t('消息栏')" :showDialog.sync="showDialog" :hasSelfFooter="true" class="unbing-dialog" :width="'684px'">
    <div class="notList">
      <el-tabs tab-position="left">
        ...
        <el-tab-pane :label="item.title" v-for="item in popUpList" :key="item.title">
          <div class="notice-wrapper">
            ...
            <div class="btn-group">
              <el-button v-if="item.outStation || item.activityId" @click="goTargetLink(item)" class="yszjl btn-detail" type="default">{{$t('查看详情')}}</el-button>
            </div>
          </div>
        </el-tab-pane>
