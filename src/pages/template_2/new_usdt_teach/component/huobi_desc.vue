    ...
    <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
      <el-tab-pane label="下载注册" name="0">
        <el-carousel arrow="always" :autoplay="false" :loop="false" height="645px" :ref="refList[0]">
          ...
          <el-carousel-item v-for="_ in 9" :key="_">
            <div :class="['level_one_second']">
              <img :width="770" :src="useCommonImgPath(`usdt_teach/${globalState.language}/huobi_${_}.png`)" alt="" />
            </div>
          </el-carousel-item>
        </el-carousel>
      </el-tab-pane>
      <el-tab-pane label="购买USDT" name="1">
        <el-carousel arrow="always" :autoplay="false" :loop="false" height="645px" :ref="refList[1]">
          <el-carousel-item v-for="_ in 5" :key="_">
            <div :class="['level_one_second']">
              <img
                width="770"
                :src="useCommonImgPath(`usdt_teach/${globalState.language}/huobi_second_${_}.png`)"
                alt="" />
            </div>
          </el-carousel-item>
        </el-carousel>
      ...
      <el-tab-pane label="平台USDT存款" name="2">
        <el-carousel arrow="always" :autoplay="false" :loop="false" height="645px" :ref="refList[2]">
          <el-carousel-item v-for="_ in 2" :key="_">
            <div :class="['level_one_second', _ == 2 && 'last']">
              <img
                :width="_ == 2 ? 375 : 770"
                :src="useCommonImgPath(`usdt_teach/${globalState.language}/huobi_third_${_}.png`)"
                alt="" />
            </div>
          </el-carousel-item>
        </el-carousel>
        ...
        <el-carousel arrow="always" :autoplay="false" :loop="false" height="645px" :ref="refList[3]">
          <el-carousel-item v-for="_ in 3" :key="_">
            <div :class="['level_one_second', _ == 3 && 'last']">
              <img
                :width="_ == 3 ? 375 : 770"
                :src="useCommonImgPath(`usdt_teach/${globalState.language}/huobi_fourth_${_}.png`)"
                alt="" />
            </div>
          </el-carousel-item>
        </el-carousel>
        ...
        <el-carousel arrow="always" :autoplay="false" :loop="false" height="645px" :ref="refList[4]">
          <el-carousel-item v-for="_ in 2" :key="_">
            <div :class="['level_one_second']">
              <img
                :width="770"
                :src="useCommonImgPath(`usdt_teach/${globalState.language}/huobi_fifth_${_}.png`)"
                alt="" />
            </div>
          </el-carousel-item>
        </el-carousel>
