    ...
    <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
      <el-tab-pane label="下载注册" name="0">
        <el-carousel arrow="always" :autoplay="false" :loop="false" height="645px" :ref="refList[0]">
          ...
          <el-carousel-item v-for="_ in 8" :key="_">
            <div :class="['level_one_second', _ == 8 && 'last']">
              <img
                :width="_ == 8 ? 375 : 770"
                :src="useCommonImgPath(`usdt_teach/${globalState.language}/zhongbi_${_}.png`)"
                alt="" />
            </div>
          </el-carousel-item>
        </el-carousel>
        ...
        <el-carousel arrow="always" :autoplay="false" :loop="false" height="645px" :ref="refList[1]">
          <el-carousel-item v-for="_ in 4" :key="_">
            <div :class="['level_one_second']">
              <img
                width="770"
                :src="useCommonImgPath(`usdt_teach/${globalState.language}/zhongbi_second_${_}.png`)"
                alt="" />
            </div>
          </el-carousel-item>
        </el-carousel>
      ...
      <el-tab-pane label="平台USDT存款" name="2">
        <el-carousel arrow="always" :autoplay="false" :loop="false" height="645px" :ref="refList[2]">
          <el-carousel-item v-for="_ in 4" :key="_">
            <div :class="['level_one_second', _ == 4 && 'last']">
              <img
                :width="_ == 4 ? 375 : 770"
                :src="useCommonImgPath(`usdt_teach/${globalState.language}/zhongbi_third_${_}.png`)"
                alt="" />
            </div>
          </el-carousel-item>
        </el-carousel>
        ...
        <el-carousel arrow="always" :autoplay="false" :loop="false" height="645px" :ref="refList[3]">
          <el-carousel-item v-for="_ in 3" :key="_">
            <div :class="['level_one_second', _ == 3 && 'last']">
              <img
                :width="_ == 3 ? 375 : 770"
                :src="useCommonImgPath(`usdt_teach/${globalState.language}/zhongbi_fourth_${_}.png`)"
                alt="" />
            </div>
          </el-carousel-item>
        </el-carousel>
        ...
        <el-carousel arrow="always" :autoplay="false" :loop="false" height="645px" :ref="refList[4]">
          <el-carousel-item v-for="_ in 2" :key="_">
            <div :class="['level_one_second']">
              <img
                :width="770"
                :src="useCommonImgPath(`usdt_teach/${globalState.language}/zhongbi_fifth_${_}.png`)"
                alt="" />
            </div>
          </el-carousel-item>
        </el-carousel>
