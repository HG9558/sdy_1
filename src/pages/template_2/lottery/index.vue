<template>
  <div :class="['electronic-partList-wrapper', site]">
    <div class="list-wrapper" v-for="gameItem in gameState.lottery" :key="gameItem.depotCode">
      <div class="game-type">
        <div class="game-classify">
          <div class="title-box">
            <img
              class="logo"
              :src="useImgPath(`lottery/logo_${gameItem.depotCode}.png`)"
        ...
        <div class="game-list" v-if="gameItem.renderList">
          <div
            ...
            @click="$emit('enterGame', dataItem, { ...dataItem, availableWh: gameItem.availableWh })">
...
const goAllList = (depotCode: string) => {
  gameState.set_lottery_depotCode(depotCode);
