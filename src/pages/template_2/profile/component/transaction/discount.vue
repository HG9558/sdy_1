<template>
  <div class="table-wrapper">
    <el-table
      ...
      <el-table-column prop="tmplName" header-align="center" align="center" :label="$t_c('优惠类型')">
      </el-table-column>
      <el-table-column prop="bonusAmount" header-align="center" align="center" :label="$t_c('彩金/奖品')">
        <template #default="scope">
          <span>
          ...
          <div class="expend-container">
            ...
            <div class="expend-container_row">
              <div>
                ...
                <span>{{ props.row.bonusAmount }}</span>
              </div>
              <div>
