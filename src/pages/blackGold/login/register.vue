    ...
    <div class="form-container">
      <el-form :model="registerForm" :rules="registerFormRule" ref="registerForm">
        ...
        <el-form-item class="code-input" prop="mobileCaptchareg" v-if="regSetting.mobileCaptcharegisVisible">
          <el-input v-model="registerForm.mobileCaptchareg" prefix-icon="el-icon-timer" :maxlength="6" clearable :placeholder="$t('短信验证码')">
        ...
        <!-- <el-form-item prop="email" v-if="regSetting.mailCaptcharegisVisible">
					<el-input class="user-input" prefix-icon="el-icon-message" v-model="registerForm.email" :maxlength="20" clearable :placeholder="$t('邮箱')">
					</el-input>
				</el-form-item> -->
