        ...
        <div class="partner-bg">
          ...
          <div class="partner-bottom-content">
            ...
            <div class="partner-right-box">
              <div class="partner-right-box_title_1">● {{$tt('appText')}}{{$t('给力的手机APP')}}</div>
...
export default {
  ...
  data() {
    return {
      ...
      organizationList: [this.$t('英属维尔京群岛(BVI)认证'), this.$t('英国GC监督委员会'), this.$t('马耳他牌照(MGA)认证'), this.$t('菲律宾(PAGCOR)认证')],
      defineIndustryPic: '',
      venturePlanPic: ''
    };
  },
