<template>
  <el-form class="bog add-bank-card-form" :model="rmbBankForm" :label-width="isZhLanguage ? '130px' : '185px'" ref="rmbBankForm" size="small" :rules="rmbBankFormDataRule">
    ...
    <el-form-item :label="$t('开户银行：')" prop="bankName">
      <el-col :span="24">
        <el-select class="w-100" popper-class="bog" @change="_getCitys" :placeholder="$t('请选择')" v-model="rmbBankForm.bankName">
    ...
    <el-form-item :label="$t('银行账号：')" prop="cardNo">
      <el-input type="number" :placeholder="$t('请输入银行账号')" :maxlength="60" v-model="rmbBankForm.cardNo"></el-input>
    </el-form-item>
  ...
  data () {
    return {
      ...
      rmbBankFormDataRule: {
        ...
        address: [],
        bankName: [{ required: true, trigger: 'change', message: this.$t('请选择开户银行') }],
      },
    }
  },
  methods: {
