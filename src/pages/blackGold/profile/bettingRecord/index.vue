    ...
    <div class="bottom-div" style="position: relative;">
      <div class="bottom-div-inner">
        ...
        <el-table class="betting-table" :data="tableData" style="width: 100%" max-height="500"  @row-click="rowClick" ref="multipleTable">
          ...
          <el-table-column prop="betTime" :label="$t('投注时间')" width="200">
          ...
          <el-table-column prop="payout" :label="$t('输/赢')">
            <template slot-scope="scope">
              <span v-if="!scope.row.payout && scope.row.payout !== 0">-</span>
              <span v-else :style="{
              ...
              <div v-if="!props.row.odds || props.row.odds.indexOf(',') === -1">
                <el-form label-position="left" inline class="demo-table-expand">
                  <el-form-item :label="$t('订单号')" style="white-space: nowrap">
                    ...
                    <span style="margin-left: 10px; color: #f9cb91; cursor: pointer;float: right;" v-clipboard:copy="props.row.id" v-clipboard:success="firstCopySuccess" v-clipboard:error="firstCopyError">{{$t('复制')}}</span>
                  </el-form-item>
                  ...
                  <el-form-item :label="props.row.odds ? $t('赔率') : ''">
              ...
              <div v-else>
                ...
                <template v-if="props.row.odds">
                  <el-form label-position="left" inline class="demo-table-expand" v-for="(item, index) in props.row.odds.split(',')" :key="'chuanguan-'+index" style="border-top: 1px solid rgba(255, 255, 255, 0.3)">
                    <el-form-item v-if="props.row.odds && props.row.odds.split(',')[index]" :label="props.row.odds ? $t('赔率') : ''">
                    ...
                    <span style="color: #f3cc9a;">
                      {{ (props.row.halfResultScore && props.row.halfResultScore.split(',')[index]) ? `${$t('半')}(${props.row.halfResultScore.split(',')[index]})  ${$t('全')}(${props.row.resultScore.split(',')[index]})`: props.row.resultScore.split(',')[index] }}
                    </span>
                    </el-form-item>
        ...
        <div class="no-data-img" v-show="shwoNodata">
          ...
          <span class="no-data-text">{{$t('暂无数据')}}</span>
        </div>
