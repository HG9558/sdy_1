<template>
  <div class="notice">
    ...
    <global-dialog :title="$t('消息公告')" :showDialog.sync="showDialog" :width="'480px'" :hasSelfFooter="false" :cancelText="$t('我知道了')" :showConfirm="false" class="notice-dialog" :appendToBody="true">
