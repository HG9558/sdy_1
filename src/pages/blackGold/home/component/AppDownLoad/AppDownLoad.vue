      ...
      <div class="main-container">
        <div class="main-title">
          ...
          <div class="service-container" @click="goService">
            ...
            <span class="servicer-text">{{$t('在线客服')}}</span>
          </div>
        </div>
        <div class="content">
          <div class="left">
            <div class="branch-title">
              <span class="branch">{{$tt('appText')}}</span>
            </div>
            <div class="slogan">
