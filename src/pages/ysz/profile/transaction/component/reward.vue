<template>
  <div>
    <el-table v-show="tableData.length !== 0" class="betting-table" :data="tableData" max-height="550" style="width: 100%">
      ...
      <el-table-column header-align="center" align="center" prop="auditAddType" label="优惠类型" width="180">
        <template slot-scope="scope">
          {{ auditAddType(scope.row.auditAddType) }}
        </template>
      </el-table-column>
      <el-table-column header-align="center" align="center" prop="actualArrival" label="优惠金额">
      </el-table-column>
