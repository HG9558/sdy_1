<template>
  <div class="coupons">
        ...
        <div class="coupons-wrap-border">
          <div class="coupons-wrap-first">
            ...
            <div class="scoend-div"
              ...
              v-if="!isMixingRule(item)">{{ item.amountMax }}元</div>
          </div>
          <div class="coupons-wrap-second" v-if="!isMixingRule(item)">
            ...
            <span v-if="isSpecialActive(item) && tmplCode(item).value">
              {{ tmplCode(item).label }}:{{ tmplCode(item).value }}元
            </span>
          </div>
    ...
    <global-dialog title="领取提示" :showDialog.sync="isShowDialog" width="450px" class="unbing-wrap" :hasSelfFooter="true">
      <div class="d-div">
