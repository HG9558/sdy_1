          ...
          <div class="select-form-container">
            ...
            <el-form class="bog rm-form" :model="feeForm" :rules="feeFormRules" ref="feeForm">
              <el-form-item prop="fee">
                <el-input type="number" class="input-money" v-show=" curPayChannel.amountType !== 1" :clearable="true" :placeholder="feePlaceholder" v-model.number="feeForm.fee" onkeyup="this.value = this.value.replace(/[^A-z0-9]/, '')"></el-input>
              </el-form-item>
