  ...
  <div class="cr-pay-container rm">
    <div v-if="!showLoading && !noData">
      ...
      <div class="select-pay-form">
           <div class="dav-w" >
              ...
              <span>
                  ...
                  <span class="tip-text-t">
                    单笔存款金额：
                    {{ renderList[payListIndex].children[payChannelIndex].amountType ? `${ renderList[payListIndex].children[payChannelIndex].fixedAmount.split(",")[0] }
                      -${renderList[payListIndex].children[payChannelIndex].fixedAmount .split(",").pop()} `
          ...
          <div class="select-card-container" v-show="recommendList.length" :class="{ 'haveRecomend':  !!recommendList.length }">
