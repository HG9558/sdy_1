      ...
      <div class="contact-us-input-box">
        <el-form :model="from" :rules="validateRule" ref="from">
          <el-form-item prop="name">
            <el-input class="user-input" v-model="from.name" :maxlength="20" clearable :placeholder="$t('名字')">
            </el-input>
          </el-form-item>
          <el-form-item prop="number">
            <el-input class="user-input" v-model="from.number" :maxlength="11" clearable :placeholder="$t('联络号码')">
            </el-input>
          </el-form-item>
          <el-form-item prop="email">
            <el-input class="user-input" v-model="from.email" clearable :placeholder="$t('邮件地址')">
            </el-input>
          </el-form-item>
          ...
          <el-form-item class="btn-class">
            <el-button :loading="isLoading" class="btn-pubilc" @click="dataFormSubmitHandle('from')">{{$t('提交')}}
            </el-button>
          </el-form-item>
        </el-form>
      </div>
