...
export default {
  ...
  data () {
    return {
      sloginsData: {
				OBSP: this.$t("提供超过400个不同联赛的足球赛事，赔率最高可比同业高出约20%。针对五大联赛开出的让球盘超195水位，让您享受到高水位投注。"),
        ...
        M8: this.$t('体育赛事全覆盖，一场比赛百种玩法，操作简单，满足新老用户，为每一位用户奉献全方位的极致体验和高端的游戏享受。'),
        IM2: this.$t('IM体育顾客至上，为您提供全面性、全球化的市场分析，提供多元且便利的游戏玩法，满足玩家需求，为您带来前所未有的体验'),
        BOS: this.$t('体育赛事全覆盖，一场比赛百种玩法，操作简单，满足新老用户，为每一位用户奉献全方位的极致体验和高端的游戏享受。'),
        PLSP: this.$t('保利体育应用大数据为玩家提供最准确的盘口，满足玩家的投注需求，让玩家享有更多的游戏选择。'),
				FBSP: this.$t("奇幻赛事、特别投注 ，各种趣味玩法，最全赛事覆盖助你花式 收米赢到人生巅峰"),
				M8VN: this.$t('体育赛事全覆盖，一场比赛百种玩法，操作简单，满足新老用户，为每一位用户奉献全方位的极致体验和高端的游戏享受。'),
        CMD: this.$t('CMD368体育应用大数据为玩家提供最准确的盘口，满足玩家的投注需求，让玩家享有更多的游戏选择。'),
        SXSP: this.$t('体育赛事全覆盖，一场比赛百种玩法，操作简单，满足新老用户，为每一位用户奉献全方位的极致体验和高端的游戏享受。'),
      },
