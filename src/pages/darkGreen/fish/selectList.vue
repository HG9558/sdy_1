    ...
    <div class="list-wrapper select-list-wrapper">
      <div class="game-type">
        <div class="game-classify">
          <div class="title-box">
            <img class="go-back" @click="$router.push('/fish')" src="../electronic/img/goback.png" alt="" />
...
export default {
  name: 'selectList',
  created () {
    !this.selectElectronicDepotCode && this.$router.push('/fish')
  },
  data () {
    return { pageNo: 1 }
  },
  computed: {
    ...mapState({
      selectElectronicDepotCode: state => state.game.selectCatchfishDepotCode,
      electronic: state => state.game.catchfish,
