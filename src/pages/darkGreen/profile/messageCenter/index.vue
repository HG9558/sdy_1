<template>
  <div class="message-wrapper">
    ...
    <div class="main-container">
      <!-- 各个组件相关 -->
      <keep-alive>
        <component :is="componentName" :messageList="messageList" @triggerSelectClick="selectClick" :pageLen="pageLen" :currentPage="reqData.pageNo" @changeCurrentPage="changeCurrentPage" :unReadCount.sync="unReadCount" :showLoading="showLoading"></component>
      </keep-alive>
