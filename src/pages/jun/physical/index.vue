...
export default {
  ...
  data() {
    return {
      sloginsData: {
        OBSP: this.$t(
          '提供超过400个不同联赛的足球赛事，赔率最高可比同业高出约20%。针对五大联赛开出的让球盘超195水位，让您享受到高水位投注。'
        ),
        OBLI: this.$t(
          '提供超过400个不同联赛的足球赛事，赔率最高可比同业高出约20%。针对五大联赛开出的让球盘超195水位，让您享受到高水位投注。'
        ),
        SBA: this.$t(
          '老牌体育平台,操作界面容易上手,可依据喜欢编排赛事,提供5种赔率模式,英国、香港、印度、马来西亚、美国等。'
        ),
        SBOVN: this.$t(
          '老牌体育平台,操作界面容易上手,可依据喜欢编排赛事,提供5种赔率模式,英国、香港、印度、马来西亚、美国等。'
        ),
        M8: this.$t(
          '体育赛事全覆盖，一场比赛百种玩法，操作简单，满足新老用户，为每一位用户奉献全方位的极致体验和高端的游戏享受。'
        ),
        IM2: this.$t(
          'IM体育顾客至上，为您提供全面性、全球化的市场分析，提供多元且便利的游戏玩法，满足玩家需求，为您带来前所未有的体验'
        ),
        BOS: this.$t(
          '体育赛事全覆盖，一场比赛百种玩法，操作简单，满足新老用户，为每一位用户奉献全方位的极致体验和高端的游戏享受。'
        ),
