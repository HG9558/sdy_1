  ...
  <div class="exclusive-vip">
    <div class="level-box">
          ...
          <div class="header-line">
            <div class="line-row" v-show="depositMinShow">
              ...
              <div class="row-center">
                <g-progress :percentage="depositMinValue" :stroke-width="8"></g-progress>
              </div>
            ...
            <div class="line-row" v-show="validbetMinShow">
              ...
              <div class="row-center">
                <g-progress :percentage="validbetMinValue" :stroke-width="8" ></g-progress>
              </div>
              <div class="row-right dark-bg">
                <span>￥{{
      ...
      <div class="vip-progress">
        <div class="progress">
          <g-progress class='level-progress' :percentage="nowLevelPercentage" :stroke-width="3"></g-progress>
        </div>
