  ...
  data() {
    return {
      sloginsData: {
        ...
        DG:
          "DG真人视讯为亚洲最具潜力的真人视讯品牌，提供百家乐、极速百家乐、共咪百家乐、多彩百家乐、龙虎、骰宝、轮盘、牛牛、炸金花等多样真人视讯游戏。DG真人视讯采用国际标准的真人游戏摄影棚，全场严密监控，流程公正公开，提供最公平的游戏环境。超低延迟高清视频，即时呈现！",
				AELI:
					"以高规格打造的AE真人配备最先进的设备以及富丽堂皇的装潢，为玩家打造绝佳真人视讯游戏体验。游戏选择多样化，包括备受欢迎的百家乐丶骰宝丶轮盘等加上全天侯监控管理，为玩家提供稳定而流畅的游戏服务",
				SA:
					"投注界面友好，玩法多样不停加入新彩池。玩家投注彩池及路线图均清晰实时显示，进座旁注不同模式。主播聊天无限欢乐，能要求延长下注时间，刺激咪牌，赢钱开心赏小费。",
        EB:
