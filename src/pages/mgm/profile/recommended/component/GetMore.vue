  ...
  <div class="get-more-container">
    <div class="self-content">
      <div class="get-more-title" @click="$emit('update:componentName', 'Recommend')">
        &lt; &nbsp;
        <span class="text"> 收益日报 </span>
      </div>
      <div class="search-container">
        <div class="search-left">
          <div class="search-left_top">
            <span class="date-text">首存时间</span>
            <div :class="{ 'date-btn': true, on: currentSelect === 'date' }" @click="currentSelect = 'date'">日</div>
            <div :class="{ 'date-btn': true, on: currentSelect === 'month' }" @click="currentSelect = 'month'">月</div>
          </div>
