    ...
    <div class="data-box">
      ...
      <div class="vip-progress">
        <div class="vip-select">
          <div :key="index" class="vip-bar-text" :class="{ 'vip-bar-text-color': vipBarTxtColorIndex === index }" v-for="(item, index) in [0, 1, 2, 3, 4, 5, 6, 7]" @click="getLevel(item, index)">
            V{{ item }}
          </div>
        </div>
        <div class="progress">
    ...
    <div v-show="birthdayFlog" class="birthday-mask">
      ...
      <div class="birthday-inner-box">
        ...
        <div class="birthday-inner">
          ...
          <div class="div-color bless">{{ birthday.donateAmount }}MYR</div>
          <div class="div-while">
