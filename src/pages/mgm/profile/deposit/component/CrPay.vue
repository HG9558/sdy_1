      ...
      <div class="select-pay-form">
        ...
        <div class="select-box">
          ...
          <div class="select-info">
            ...
            <div class="info-item exchange-num">当前参考汇率： 1 USDT ≈ {{exchangeRate}} MYR</div>
            <div class="info-item get-money">预计到账金额：{{userGetMoney}} MYR</div>
          </div>
        </div>
      </div>
      ...
      <div class="cr-pay-dialog">
        ...
        <div>
          <div class="cr-line">
            ...
            <span class="cr-value">{{crPayInfo.depositAmountCNY}} MYR</span>
          </div>
          <div class="cr-line">
