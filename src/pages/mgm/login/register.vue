    ...
    <div class="form-container">
      <el-form :model="registerForm" :rules="registerFormRule" ref="registerForm">
        ...
        <el-form-item prop="loginName" v-if="regSetting.loginNameisVisible">
          <el-input class="user-input" prefix-icon="el-icon-user" v-model="registerForm.loginName" :maxlength="10" clearable placeholder="用户名">
          </el-input>
        </el-form-item>

        <el-form-item prop="loginPwd" v-if="regSetting.loginPwdisVisible">
          <el-input class="user-input" prefix-icon="el-icon-lock" v-model.trim="registerForm.loginPwd" type="password" :maxlength="18" clearable placeholder="密码">
          </el-input>
        </el-form-item>

        <el-form-item prop="reLoginPwd" v-if="regSetting.reLoginPwdisVisible">
          <el-input class="user-input" prefix-icon="el-icon-lock" v-model.trim="registerForm.reLoginPwd" type="password" :maxlength="18" clearable placeholder="确认密码">
          </el-input>
        </el-form-item>
        ...
        <el-form-item prop="weChat" v-if="regSetting.weChatisVisible">
          <el-input class="wechat-input" prefix-icon="el-icon-wechat" v-model="registerForm.weChat" :maxlength="20" clearable placeholder="微信">
          </el-input>
        </el-form-item>
        ...
        <el-form-item class="mobile-login-form" prop="mobile" :rules="activeMobileAreaCfg.rules" v-if="regSetting.mobileisVisible">
          <MobileAreaCodesSelect v-model="mobileAreaCode" @select="onSelectAreaCode" />
          <el-input class="mobile-select" prefix-icon="el-icon-mobile-phone" v-model="registerForm.mobile" :maxlength="activeMobileAreaCfg.maxlength" clearable placeholder="手机号码">
          </el-input>
        </el-form-item>

        <el-form-item class="code-input" prop="mobileCaptchareg" v-if="regSetting.mobileCaptcharegisVisible">
          <el-input v-model="registerForm.mobileCaptchareg" :maxlength="6" placeholder="短信验证码">
      ...
      <el-button class="bog login-btn" :disabled="btnDisabled" @click="submitRegisterForm" width="360" :loading="isLoading">
        <span class="ft-16" style="cursor: pointer;">注册</span>
      </el-button>
