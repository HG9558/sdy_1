<template>
  <div class="withdrawal-container">
    ...
    <div class="tab-container">
      ...
      <div :class="{'tab-list':true,'on':tabActive==='otherpay'}" @click="tabActive='otherpay'">
...
export default {
  ...
  methods: {
    ...
    ...mapMutations('user', ['set_alipay_enable', 'set_ebpay_enable', 'set_topay_enable', 'set_cnyWithdrawEnable_enable']),
    init () {
    ...
    async _isWithdrawal () {
      ...
      const { alipayEnable, ebPayWithdrawEnable, toPayWithdrawEnable, cnyWithdrawEnable } = res.data.data
      this.set_cnyWithdrawEnable_enable(!!cnyWithdrawEnable)
      this.isPassed = res.data.data.isPassed;
      // const { alipayEnable } = res.data.data
