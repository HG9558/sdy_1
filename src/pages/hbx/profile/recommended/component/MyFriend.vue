<template>
  <div class="my-friend-wrapper">
    ...
    <div class="content">
      ...
      <!-- 表格 -->
      <common-table :showSummary="true" :reloadTotal="reloadTotal" @getFriendDetail="getFriendDetail" :tableData="tableData" :tableLabel="tableLabel" :pageNo.sync="pageNo" :loading="loading" :total="total" />
    </div>
  </div>
</template>
