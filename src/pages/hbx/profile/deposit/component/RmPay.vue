       ...
       <div class="tip">
        ...
        <div class="select-box rm-box">
          ...
          <div class="select-form-container">
            ...
            <el-button :class="{'handle-btn bog btn-deposit':true , 'rm-handle-btn':curPayChannel.amountType ===1}" @click="_rmPayDeposit" :loading="buttonLoading">立即存款</el-button>
...
export default {
  ...
  data () {
    return {
      ...
      renderList: [
        ...
        { label: "聚合支付", children: [], imageUrl: 'new_jvhe' },
      ],
      bankList: [],
      noticeTextData,
      feeForm: {
  ...
  methods: {
    ...
    getPzpayPictureUrl (response) {
      ...
      //- 聚合支付
      res.aggregationPayList && res.aggregationPayList.length && this.renderList[6].children.push(...res.aggregationPayList);
