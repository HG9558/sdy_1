  ...
  <div class="exclusive-vip">
    ...
    <div v-if="
      ...
      <div class="row text-center vip-center">
        ...
        <div class="col px-0">
          ...
          <div class="fs-0-7">升级礼金（晋级自动发放）</div>
        </div>
        <div class="col px-0">
          <div class="font-weight-bolder">
              <span v-if="nowVipLevel===0">0</span>
        ...
        <div class="col px-0">
          ...
          <div class="fs-0-7">每月红包（月初自动发放）</div>
        </div>
      </div>
    </div>
    <div class="data-box vip-box" v-show="
      ...
      <div class="row bottom-btn-group">
        <el-select class="bog-select" popper-class="bog" v-model="venueName" placeholder="查看指定场馆">
