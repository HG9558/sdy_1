<template>
  <div class="real-info-description">
    ...
    <el-form :model="form" class="bog real-form" label-position="top" label-width="115px" ref="form" :rules="registerFormRule">
      <el-form-item label="真实姓名：" :prop="!!exitRealName ? '' : 'realName'">
        <el-input class="user-name" placeholder="姓名需与银行卡持卡人姓名一致，否则无法提款" style="width: 362px" v-model="form.realName" :disabled="!!exitRealName"></el-input>
      </el-form-item> 
      <el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" class="bog submit-userinfo-button" :disabled="btnDisabled" @click="_onSubmitForm" :loading="loading">提交</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
