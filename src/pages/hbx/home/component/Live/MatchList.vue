<template>
  <div class="match-comp">
    ...
    <el-scrollbar wrap-class="list-wrapper" ref="scrollBar">
      <div class="match-list" v-if="tabIndex !== 4" :class="{ 'no-data': JSON.stringify(endObj) === '{}' }">
        <div class="match-item" :class="{
          ...
          <div @click="handleChangeLive(matchItem)" :class="[ 'match-inner', {'playing': matchItem.matchId === matchId}]" v-for="(matchItem, index) in match" :key="matchItem.groupId + index"  v-show="foldList.includes(match[0].matchDate)">
