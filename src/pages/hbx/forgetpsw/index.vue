<template>
  <div class="box">
    <div class="content">
      ...
      <div class="stpe">
        <div :class="['stpe-one',{'dark-bg':active === 2}]">1、填写手机号</div>
        ...
        <div class="row">
          <div class="reg-card col py-3">
            <el-form :model="loginForm" :rules="logindataRule" ref="logindataForm">
              <el-form-item :rules="activeMobileAreaCfg.rules" prop="phone">
                <MobileAreaCodesSelect v-model="mobileAreaCode" @select="loginForm.phone = ''" />
                <el-input class="user-input phone" v-model="loginForm.phone" :maxlength="activeMobileAreaCfg.maxlength" clearable placeholder="请输入您的手机号">
                </el-input>
              </el-form-item>
...
export default {
  ...
  computed: {
    ...
    beginAnim () {
      return (
        this.loginForm.phone !== "" && this.activeMobileAreaCfg.reg.test(this.loginForm.phone)
      );
    },
    activeMobileAreaCfg() {
